...
function drawMenu($menu, $vertical=true){
	$arr=array(
	 index => "<li><a href='index.php'>Домой<a></li>",
	 about => "<li><a href='about.php'>О нас</a></li>",
	 contact => "<li><a href='contact.php'>Контакты</a></li>",
	 table => "<li><a href='table.php'>Таблица умножения</a></li>",
	 calc => "<li><a href='calc.php'>Калькулятор</a></li>");
	$menu = $arr;
	echo(menu);
}
drawMenu($menu);
